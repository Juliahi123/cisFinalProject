"use strict";
var quoteGroup = ["Love For All, Hatred For None. – Khalifatul Masih",
...
randQuote();
setInterval("randQuote()", 2000);
var htmlCode ="";
function randQuote(){
    var randomNumber = Math.floor(Math.random()*(quoteGroup.length));
    htmlCode ="<span1> Random Quote Generator </span1> </br>";
    htmlCode +="<span>" + quoteGroup[randomNumber] + "</span>";
    document.getElementById("eventList").innerHTML = htmlCode;
